# # =====================================================
# # CLIENTE SUPABASE PARA SISTEMA ODONTOLÓGICO - VERSIÓN CORREGIDA
# # =====================================================
...
#     """Cliente Supabase para el sistema odontológico - VERSIÓN CORREGIDA"""
    
#     def __init__(self):
#         print("[DEBUG] ===== INICIALIZANDO CLIENTE SUPABASE =====")
...
#             print(f"[ERROR] {error_msg}")
#             print("[INFO] Sin service_key no se pueden crear usuarios en Supabase Auth")
...
#             print(f"[ERROR] ❌ Fallo crítico al crear cliente Supabase: {str(e)}")
#             print(f"[ERROR] 🔧 Detalles del error: {type(e).__name__}")
            
#             # Errores específicos
#             if "invalid" in str(e).lower():
#                 print("[ERROR] 🔑 Las claves parecen ser inválidas")
#             elif "network" in str(e).lower():
#                 print("[ERROR] 🌐 Problema de conexión de red")
#             elif "unauthorized" in str(e).lower():
#                 print("[ERROR] 🔒 Problema de autorización")
...
#     """
#     Decorador para manejar errores de Supabase de forma consistente
#     """
...
#             raise SupabaseError(f"Error en la base de datos: {str(e)}")
#     return wrapper    
