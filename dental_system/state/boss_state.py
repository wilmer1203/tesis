"""
Estado específico para el rol de Gerente/Jefe - VERSIÓN OPTIMIZADA
...
class BossState(SharedManagerState):
    """
    Estado específico para el gerente/jefe - OPTIMIZADO
    Hereda funcionalidad común y agrega funciones específicas del jefe
    """
    
    # ==========================================
    # DATOS ESPECÍFICOS DEL BOSS - TIPADOS
    # ==========================================
    ...
    # ==========================================
    # GESTIÓN DE PERSONAL (EXCLUSIVO DEL BOSS)
    # ==========================================
    ...
    # ==========================================
    # GESTIÓN DE SERVICIOS (EXCLUSIVO DEL BOSS)
    # ==========================================
    ...
    def randomize_data(self):
        ...
        for i in range(30, -1, -1):
            date_str = (datetime.datetime.now() - datetime.timedelta(days=i)).strftime("%d-%m")
    ...
    # ==========================================
    # NAVEGACIÓN ESPECÍFICA DEL BOSS
    # ==========================================
    
    @rx.event
    async def navigate_to(self, page: str):
        """Navegación específica del boss con carga de datos"""
        print(f"[DEBUG] Boss navegando a página: {page}")
        ...
        if page == "dashboard":
            ...
            await self.load_pacientes_data()  # Vista de solo lectura
        elif page == "consultas":
            await self.load_consultas_data(for_boss=True)  # Vista de solo lectura
        elif page == "pagos":
    ...
    async def _apply_dashboard_stats(self, stats: Dict[str, Any]):
        """Aplica estadísticas específicas del boss"""
        self.dashboard_stats = DashboardStatsModel(**stats)
        
        # Cargar estadísticas específicas de pacientes y pagos
    ...
    async def _apply_pacientes_data(self, pacientes: List):
        """Aplica datos de pacientes (CRUD completo para admin)"""
        self.pacientes_list = pacientes
    
    async def _apply_consultas_data(self, consultas: List, for_boss: bool = False):
        """Aplica datos de consultas (vista de solo lectura para boss)"""
        self.consultas_list = consultas
        self.consultas_hoy = consultas  # Para el boss, misma vista
    
    # ==========================================
    # GESTIÓN DE PERSONAL (ESPECÍFICO DEL BOSS)
    # ==========================================
    
    async def load_personal_data(self):
        """Cargar datos del personal"""
        print("[DEBUG] Boss cargando datos del personal")
        ...
        try:
            ...
            print(f"[DEBUG] ✅ Personal convertido: {len(self.personal_list)} registros")
    ...
    # Operaciones CRUD de personal (mantenidas del código original)
    async def save_personal(self):
        """Guardar personal usando tablas separadas"""
    ...
    async def _create_personal(self):
        """Crear nuevo personal usando Supabase Auth"""
    ...
    # ==========================================
    # GESTIÓN DE SERVICIOS (ESPECÍFICO DEL BOSS)
    # ==========================================
    
    async def load_servicios_data(self):
        """Cargar datos de servicios"""
        print("[DEBUG] Boss cargando datos de servicios")
        self.set_loading(True)
        try:
            ...
            print(f"[DEBUG] Servicios cargados: {len(self.servicios_list)} registros")
    ...
    async def save_servicio(self):
        """Guardar servicio usando ServicesTable"""
    ...
    # ==========================================
    # VISTAS DE SOLO LECTURA PARA PAGOS
    # ==========================================
    
    async def load_pagos_data(self):
        """Cargar vista de pagos (solo lectura para boss)"""
        print("[DEBUG] Boss cargando vista de pagos...")
        self.set_loading(True)
        try:
            # Solo estadísticas para el boss
            stats = await dashboard_service.get_pagos_stats()
            self.pagos_stats = PagosStatsModel(**stats)
            print(f"[DEBUG] Estadísticas de pagos cargadas: {stats}")
    ...
    def on_load(self):
        """Cargar datos iniciales del boss"""
        print("[DEBUG] Inicializando BossState optimizado...")
