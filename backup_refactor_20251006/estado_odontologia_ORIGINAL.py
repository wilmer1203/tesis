...
class EstadoOdontologia(EstadoOdontogramaAvanzado, mixin=True):
    ...
    historial_cambios_diente: List[Dict[str, Any]] = []  # Necesario para rx.foreach
    filtro_historial_tipo: str = "Todos"
    filtro_historial_tiempo: str = "Todo el tiempo"
    alertas_diente_activas: List[Dict[str, Any]] = []  # Necesario para rx.foreach
    recordatorios_diente: List[Dict[str, Any]] = []  # Necesario para rx.foreach
    ...
    notificaciones_activas: List[Dict[str, Any]] = []  # Necesario para rx.foreach
